...
distribution_t init_distribution_c(string, int&);

distribution_t init_distribution_d(string, int&);
...
int select_c(distribution_t, int);
int select_d(distribution_t, int);
