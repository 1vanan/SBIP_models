...
distribution_t init_distribution_c(string f, int& size)
{
	int i = 0;
	int j = 0;
	string line;
...
distribution_t init_distribution_d(string f, int& size)
{
	int i = 0;
	int j = 0;
	string line;
...
int select_c(distribution_t dist, int size)
{
	timeval time;
	gettimeofday(&time, NULL);
	srand(time.tv_usec);
...
int select_d(distribution_t dist, int size)
{
	timeval time;
	gettimeofday(&time, NULL);
	srand(time.tv_usec);
